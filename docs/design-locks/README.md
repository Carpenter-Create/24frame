...
- [`dm-vs-group-membership-lock-v1.md`](dm-vs-group-membership-lock-v1.md) — 1:1 stays two people. A group starts only from a fresh Messages compose. Cap 32, shown as N/32. Does not reopen header density or the composer.
