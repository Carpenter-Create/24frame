...
- [`social-home-composer-fb-row-sheet-lock-v1.1.md`](social-home-composer-fb-row-sheet-lock-v1.1.md) — Same FB row. Field is white with a hairline. Photo and Camera are glyph 16, hit 32, flush. Supersedes v1 tokens only
