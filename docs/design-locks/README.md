...
- [`24frame-visual-register-rich-calm-lock-v1.md`](24frame-visual-register-rich-calm-lock-v1.md) — Rich calm v1.3. G0: rich video and media are required at peer grade. Register stays Coinbase, professional, 24Frame, and thoughtful. Paint on the viewer and home rail. Geometry closed. Create-story shutter stays v1.5.
