...
- [`stories-send-dm-craft-lock-v1.md`](stories-send-dm-craft-lock-v1.md) — Send-story DM craft v1.1: 2000ms sent toast, calm body, 168 story card, live SocialFeedVideo. Supersedes poster-only send. Not #664. Heart stays on the actions lock.
