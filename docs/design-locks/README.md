...
- [`24frame-visual-register-rich-calm-lock-v1.md`](24frame-visual-register-rich-calm-lock-v1.md) — Rich calm v1.2 final. Register is Coinbase, professional, 24Frame, and thoughtful. Primary richness is video and media; the rich media bar is required. Paint on the viewer and home rail. Geometry closed. Create-story shutter stays v1.5.
