...
- [`write-compose-voice-first-immersive-lock-v1.md`](write-compose-voice-first-immersive-lock-v1.md) — Write compose is house-light voice-first, rich-calm §0. Attached media sits above the caption. No Following chip. X leaves for Social home
