...
- [`social-home-post-actions-align-lock-v1.md`](social-home-post-actions-align-lock-v1.md) — Like, Comment, and Share are one triplet. Hit 40, glyph 24, gap 16, shared optical baseline. Same component on phone and desktop
