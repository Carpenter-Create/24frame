...
- [`write-compose-voice-first-immersive-lock-v1.md`](write-compose-voice-first-immersive-lock-v1.md) — Write compose is house-light. §0.4 kind=text is the iMessage path: caption on white, camera far-right opens the library, no mic. No gray plate. No Following chip. X leaves for Social home
