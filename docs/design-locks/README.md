...
- [`social-home-composer-fb-row-sheet-lock-v1.md`](social-home-composer-fb-row-sheet-lock-v1.md) — Home composer is one row: avatar 40, Share something pill, icon-only Photo then Camera. Supersedes spine density v1.1 §A. Stories, Topics, gaps, and feed bleed stay on v1.1
