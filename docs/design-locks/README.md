...
- [`24frame-visual-register-rich-calm-lock-v1.md`](24frame-visual-register-rich-calm-lock-v1.md) — Rich calm v1.1. Paint on the viewer and home rail: media vitality, scrims, sparse Sporty Blue, stage fade 180ms, neighbor slide 220ms, linear progress. Create-story shutter stays v1.5 geometry. Does not reopen viewer, rail, or create-story geometry.
