...
- [`social-home-composer-fb-row-sheet-lock-v1.2.md`](social-home-composer-fb-row-sheet-lock-v1.2.md) — Share something has no drawn edge: transparent fill, no border, no shadow. Supersedes v1.1 field fill and border only. Icons stay v1.1
