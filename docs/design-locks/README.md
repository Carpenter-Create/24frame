...
- [`24frame-visual-register-rich-calm-lock-v1.md`](24frame-visual-register-rich-calm-lock-v1.md) — Rich calm v1.2. Primary richness is video and media on the viewer and home rail. Chrome stays Coinbase calm. Listed motion only. Create-story shutter stays v1.5 geometry. Does not reopen viewer, rail, or create-story geometry.
