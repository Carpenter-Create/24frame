...
- [`social-home-spine-density-lock-v1.md`](social-home-spine-density-lock-v1.md) — Phone-first Home spine: share-stage composer, larger Stories, bleed feed media, section gap 16
