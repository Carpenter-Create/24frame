...
- [`write-compose-voice-first-immersive-lock-v1.md`](write-compose-voice-first-immersive-lock-v1.md) — Write compose is a house-light voice hero. Text is a bottom Share something bar. Attached media previews above that bar and the hero yields
