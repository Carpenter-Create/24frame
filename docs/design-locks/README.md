...
- [`write-compose-voice-first-immersive-lock-v1.md`](write-compose-voice-first-immersive-lock-v1.md) — Write compose is house-light voice-first. §0.2 presence: voice 220, denser muted fill, Share something optically centered. No Following chip. X leaves for Social home
