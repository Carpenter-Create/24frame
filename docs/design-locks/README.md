...
- [`social-feed-photo-scale-immersive-lock-v1.md`](social-feed-photo-scale-immersive-lock-v1.md) — Feed media cap `min(70vh, 560)` with caption under the face. Tap opens one fullscreen immersive. Desktop right rail is out.
