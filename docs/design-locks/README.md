...
- [`social-home-spine-density-lock-v1.1.md`](social-home-spine-density-lock-v1.1.md) — Launch-great Home spine. Two-row Photo · Camera composer, Stories 136×240, Topics chip 32, section gap 8. Supersedes v1 density feel. Share something copy stays on the share-copy lock
