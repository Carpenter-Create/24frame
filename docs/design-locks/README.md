...
- [`social-explore-discovery-lock-v1.md`](social-explore-discovery-lock-v1.md) — Explore is trending plus search in one media grid. 3-col phone, 4-col desktop, hairline 2, phone full-bleed. Tap opens the Home post.
