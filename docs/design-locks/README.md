...
- [`stories-send-dm-craft-lock-v1.md`](stories-send-dm-craft-lock-v1.md) — Send-story DM craft v1.4: one IG-dark share drawer, same-sheet morph, centered Sent toast, live story card. Supersedes the white AppSheet sheet and the bottom toast. Not #664. Heart stays on the actions lock.
