...
- [`social-home-composer-fb-row-sheet-lock-v1.3.md`](social-home-composer-fb-row-sheet-lock-v1.3.md) — Composer outer band is 32, the same as Topics. Host pad Y 0, border none, radius 0, transparent. Avatar 32, field 32, radius 16, gap 8. Supersedes v1–v1.2 stage height and host chrome. Field-air v1.2 and icons v1.1 stay
- [`social-home-composer-fb-row-sheet-lock-v1.4.md`](social-home-composer-fb-row-sheet-lock-v1.4.md) — One hairline between Topics and the composer. 1px house hairline, center-column width, outside the 32 band. No surround. Host stays v1.3
