...
import { EDUCATION_ADMIN, EDUCATION_MANAGE_HREF } from "@/lib/education";
...
describe("EducationCourseRail copy lock", () => {
  it("lists course names and New course only — no Welcome, Home, or New & For You", () => {
    ...
    expect(html).toContain(`${EDUCATION_MANAGE_HREF}/orientation`);
    ...
    const src = readFileSync("src/app/(app)/(operator)/education/manage/education-course-rail.tsx", "utf8");
