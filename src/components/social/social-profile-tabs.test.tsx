...
describe("SocialProfileTabs", () => {
  it("ships Posts | Highlights | Credits as a horizontal scroll menu", () => {
    ...
    expect(html.indexOf('data-social-profile-tab="posts"')).toBeLessThan(
