...
import { SOCIAL_FOR_YOU_CARD_CLASS, SOCIAL_TOPIC_CHIP_CLASS } from "@/lib/social-chrome";
import { SOCIAL_CATEGORY_TOPICS, socialHomeLensHref } from "@/lib/social-categories";
import { SOCIAL } from "@/lib/social";

export function SocialTopics() {
  return (
    <div data-social-home-topics="" className={SOCIAL_FOR_YOU_CARD_CLASS}>
