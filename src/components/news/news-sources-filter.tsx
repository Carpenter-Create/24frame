...
// All first, then NEWS_SOURCES (A–Z by label). Selected is accent
// blue (workspace Home segmented fill), idle is muted surface.
// Multi-select writes ?source= comma-separated ids. Phone scrolls
// the row; never a checkbox rail or a second bottom float.
