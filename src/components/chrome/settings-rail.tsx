...
// Settings hub rail — occupies the 220 Access slot. Quiet Settings
// context (not a page H1). Profile · Organization · Preferences.
// House muted wash. Not a workspace switch. Same URLs from every
// workspace. Body H1 is the hub section.
