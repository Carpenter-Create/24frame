...
export const NOTIFICATION_PREF_GROUP_CLASS = `flex flex-col ${HOUSE_SECTION_AIR_CLASS}`;
export const NOTIFICATION_PREF_SECTION_CLASS = SETTINGS_PREF_BLOCK_CLASS;
...
export const NOTIFICATION_PREF_LIST_CLASS = "flex flex-col divide-y divide-hairline";
...
// translate 36 − 16 − 2 = 18. Accent on / muted off. No second Switch.
