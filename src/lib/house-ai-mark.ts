 ...
 *  #448 collapsed to 20px, #449 dropped the phone header to 16px,
 *  #450 briefly pulled both to 20px, and #451 (authoritative) split
 *  again with the phone header back at the 16px desktop-chrome
 *  optical. The bump holds at every step because it compensates for
 *  the geometric tip softening rather than a specific pixel width. */
