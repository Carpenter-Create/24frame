...
describe("Dashboard top-row height pair (Net | Attention)", () => {
  ...
  it("G2/G4 — Attention content stays top-aligned; no filler charts or fake rows", () => {
  ...
  it("G3 — empty Attention still uses the shared fill contract (no shrink-wrap class)", () => {
    const html = renderHero([]);
