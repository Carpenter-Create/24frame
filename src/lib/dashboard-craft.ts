...
// Row meta (outlet · absolute date) — house muted type only
// (Adam lock 2026-09-19). Not a status pill, filter chip, or
// lookalike badge. Filter pills stay on DASHBOARD_NEWS_SOURCE_CHIP_*.
