...
export const FINANCE_PAGE = {
  ...
  mapHint: "Resolve vendor ids onto this rights holder’s titles only.",
  ...
  suspense: "Suspense",
  suspenseHint:
    "Parked unmapped lines. Assign to an open period for that rights holder, then map.",
